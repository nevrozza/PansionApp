...
data object RIcons {
    ...
    const val CHEVRON_LEFT = "chevron-left-solid.svg"
    const val MAGIC_WAND = "wand-magic-sparkles-solid.svg"
    ...
    const val TRASH_CAN_REGULAR = "trash-can-regular.svg"
    const val REFRESH = "rotate-right-solid.svg"
    const val SOVIET_SETTINGS = "screwdriver-wrench-solid.svg"
    const val GROUP = "users-solid.svg"
    const val SMALL_GROUP = "user-group-solid.svg"
    const val HOME = "house-solid.svg"
    const val SCHOOL = "school-solid.svg"
    const val BOOK = "book-solid.svg"
    const val CONTACT_BOOK = "address-book-regular.svg"
    ...
    const val SCHOOL_CAP = "graduation-cap-solid.svg"
    const val SCHOOL_CAP_OUTLINE = "graduation-cap-outlined.svg"

    const val MGU = "MGU.png"

    const val USER = "user-solid.svg"

    const val VISIBILITY_OFF = "eye-slash-solid.svg"
    const val VISIBILITY = "eye-solid.svg"


    const val QUESTION_CIRCLE = "circle-question-regular.svg"

    const val BIG_BRUSH = "brush-solid.svg"
    ...
    const val PERSON_ADD = "user-plus-solid.svg"

    const val SWAP_HORIZ = "arrow-right-arrow-left-solid.svg"

    const val ERROR_OUTLINE = "circle-exclamation-solid.svg"
    ...
    const val STAR_OUTLINE = "star-regular.svg"

    const val SHIELD = "shield-cat-solid.svg"

    const val MORE_VERT = "ellipsis-vertical-solid.svg"

    const val COINS = "coins-solid.svg"

    const val ROCKET_LAUNCH = "rocket-launch-solid.svg"
    ...
    const val CUTE_CHECK = "cute-check.svg"

    const val CHECK_CIRCLE_OUTLINE = "circle-check-regular.svg"

    const val RESTARAUNT = "utensils-solid.svg"

    const val SCHEDULE = "clock-regular.svg"

    const val HOURGLASS_BOTTOM = "hourglass-end-solid.svg"

    const val DINING = "dining-solid.svg"

    const val RECEIPT = "receipt-solid.svg"

    const val MANAGE_SEARCH = "manage-search-solid.svg"

    const val PLAYLIST_ADD_CHECK_CIRCLE = "playlist-add-check-circle.svg"

    const val MINUS = "minus-solid.svg"

    const val AUTO_MODE = "auto-mode-solid.svg"
    const val DARK_MODE = "dark-mode-solid.svg"
    const val LIGHT_MODE = "light-mode-solid.svg"
    ...
    const val FLASHLIGHT_ON = "flashlight-on-solid.svg"
    const val FLASHLIGHT_OFF = "flashlight-off-solid.svg"
