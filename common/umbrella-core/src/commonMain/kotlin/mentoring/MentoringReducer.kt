...
object MentoringReducer : Reducer<State, Message> {
    override fun State.reduce(msg: Message): State {
        return when (msg) {
            is Message.StudentsFetched -> copy(forms = msg.forms.formSort(), students = msg.students, requests = msg.requests)
            ...
            is Message.FormsUpdated -> copy(forms = msg.forms.formSort())
